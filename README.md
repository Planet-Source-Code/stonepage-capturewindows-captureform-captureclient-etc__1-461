...
**Archive File**   |[](https://github.com/Planet-Source-Code/stonepage-capturewindows-captureform-captureclient-etc__1-461/archive/master.zip)
...
ByVal hDCSrc As Integer, ByVal XSrc As Integ
```
